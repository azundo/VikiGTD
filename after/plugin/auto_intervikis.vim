...
" Set up some other helpful commands for log app
exec "command Today edit ".$HOME."/Wikis/log/weeks/days/".strftime("%Y-%m-%d", localtime()).".viki"
exec "command Tomorrow edit ".$HOME."/Wikis/log/weeks/days/".strftime("%Y-%m-%d", localtime() + 24*60*60).".viki"
exec "command Yesterday edit ".$HOME."/Wikis/log/weeks/days/".strftime("%Y-%m-%d", localtime() - 24*60*60).".viki"
exec "command ThisWeek edit ".$HOME."/Wikis/log/weeks/".strftime("%Y-%m-%d", s:GetSundayForWeek(localtime())).".viki"
exec "command LastWeek edit ".$HOME."/Wikis/log/weeks/".strftime("%Y-%m-%d", s:GetSundayForWeek(localtime() - 7*24*60*60)).".viki"
